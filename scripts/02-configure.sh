...
cp "$PROJECT_ROOT/src/eclipse-drivers" "$ROOTFS/usr/local/bin/"
...
cp "$PROJECT_ROOT/config/desktop/eclipse-drivers.desktop" "$ROOTFS/usr/share/applications/"
chmod +x "$ROOTFS/usr/local/bin/eclipse-sysinfo" "$ROOTFS/usr/local/bin/eclipse-control" "$ROOTFS/usr/local/bin/eclipse-installer" "$ROOTFS/usr/local/bin/eclipse-drivers" "$ROOTFS/usr/local/bin/eclipse-dock" "$ROOTFS/usr/local/bin/dnf"
